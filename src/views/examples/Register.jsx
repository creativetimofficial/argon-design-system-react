              ...
              <Container>
                <Row className="row-grid align-items-center mb-5">
                  ...
                  <Col className="text-lg-center btn-wrapper" lg="6">
                    ...
                    <UncontrolledTooltip delay={0} target="tooltip80162749">
                      Follow us
                    </UncontrolledTooltip>
                    <Button
                      className="btn-neutral btn-icon-only btn-round"
                    ...
                    <UncontrolledTooltip delay={0} target="tooltip329621294">
                      Like us
                    </UncontrolledTooltip>
                    <Button
                      className="btn-neutral btn-icon-only btn-round"
                    ...
                    <UncontrolledTooltip delay={0} target="tooltip832782343">
                      Follow us
                    </UncontrolledTooltip>
                    <Button
                      className="btn-neutral btn-icon-only btn-round"
                    ...
                    <UncontrolledTooltip delay={0} target="tooltip225890789">
                      Star on Github
                    </UncontrolledTooltip>
                  </Col>
                </Row>
