...
<NavItem>
<NavLink className=" nav-link-icon" href="https://www.facebook.com/creativetim" id="tooltip409201519" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip409201519">
Like us on Facebook
</UncontrolledTooltip>
</NavItem>
<NavItem>
<NavLink className=" nav-link-icon" href="https://www.instagram.com/creativetimofficial" id="tooltip63636080" target="_blank">
...
<NavItem>
<NavLink className=" nav-link-icon" href="https://twitter.com/creativetim" id="tooltip250727030" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip250727030">
Follow us on Twitter
</UncontrolledTooltip>
</NavItem>
<NavItem>
<NavLink className=" nav-link-icon" href="https://github.com/creativetimofficial/argon-design-system" id="tooltip718528286" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip718528286">
Star us on Github
</UncontrolledTooltip>
</NavItem>
...
A beautiful Design System <span>
...
<Button className=" btn-icon mb-3 mb-sm-0" color="info" href="https://demos.creative-tim.com/argon-design-system/docs/components/alerts.html">
<span className=" btn-inner--icon">
...
<Button className=" btn-white btn-icon mb-3 mb-sm-0" color="default" href="https://www.creative-tim.com/product/argon-design-system">
<span className=" btn-inner--icon">
...
<Button className=" mt-4" color="primary" href="#pablo" onClick={e =>
 e.preventDefault()}>
Learn more
</Button>
</CardBody>
...
<Button className=" mt-4" color="success" href="#pablo" onClick={e =>
 e.preventDefault()}>
Learn more
</Button>
</CardBody>
...
<Button className=" mt-4" color="warning" href="#pablo" onClick={e =>
 e.preventDefault()}>
Learn more
</Button>
</CardBody>
...
<img alt="..." className=" img-fluid floating" src={require("assets/img/theme/promo-1.png")}>
</img>
</Col>
...
<a className=" font-weight-bold text-warning mt-5" href="#pablo" onClick={e =>
 e.preventDefault()}>
...
<a className=" text-success" href="#pablo" onClick={e =>
 e.preventDefault()}>
Learn more
</a>
</div>
...
<a className=" text-warning" href="#pablo" onClick={e =>
 e.preventDefault()}>
Learn more
</a>
</div>
...
<div className=" mt-3">
<Button className=" btn-icon-only rounded-circle" color="warning" href="#pablo" onClick={e =>
 e.preventDefault()}>
...
<div className=" mt-3">
<Button className=" btn-icon-only rounded-circle" color="primary" href="#pablo" onClick={e =>
 e.preventDefault()}>
<i className=" fa fa-twitter">
</i>
</Button>
...
<div className=" mt-3">
<Button className=" btn-icon-only rounded-circle" color="info" href="#pablo" onClick={e =>
 e.preventDefault()}>
<i className=" fa fa-twitter">
</i>
</Button>
...
<div className=" mt-3">
<Button className=" btn-icon-only rounded-circle" color="success" href="#pablo" onClick={e =>
 e.preventDefault()}>
<i className=" fa fa-twitter">
</i>
</Button>
...
<Button block className=" btn-white" color="default" href="https://www.creative-tim.com/product/argon-design-system" size="lg">
Download HTML
</Button>
</Col>
</Row>
...
<Input className=" form-control-alternative" cols="80" name="name" placeholder="Type a message..." rows="4">
</Input>
</FormGroup>
<div>
...
<h2 className=" display-3">
Do you love this awesome <span className=" text-success">
...
<div className=" btn-wrapper">
<Button className=" mb-3 mb-sm-0" color="primary" href="https://www.creative-tim.com/product/argon-design-system">
Download HTML
</Button>
</div>
...
<Row className=" justify-content-center">
<Col lg="2" xs="4">
<a href="https://www.creative-tim.com/product/argon-design-system" id="tooltip83811324" target="_blank">
<img alt="..." className=" img-fluid" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/bootstrap.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip83811324">
Bootstrap 4 - Most popular front-end component library
</UncontrolledTooltip>
</Col>
<Col lg="2" xs="4">
<a href=" https://www.creative-tim.com/product/vue-argon-design-system" id="tooltip571169241" target="_blank">
<img alt="..." className=" img-fluid" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/vue.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip571169241">
Vue.js - The progressive javascript framework
</UncontrolledTooltip>
</Col>
<Col lg="2" xs="4">
<a href=" https://www.sketchapp.com/" id="tooltip76383242" target="_blank">
<img alt="..." className=" img-fluid opacity-3" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/sketch.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip76383242">
[Coming Soon] Sketch - Digital design toolkit
</UncontrolledTooltip>
</Col>
<Col lg="2" xs="4">
<a href=" https://www.adobe.com/products/photoshop.html" id="tooltip251621092" target="_blank">
<img alt="..." className=" img-fluid opacity-3" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/ps.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip251621092">
[Coming Soon] Adobe Photoshop - Software for digital images manipulation
</UncontrolledTooltip>
</Col>
<Col lg="2" xs="4">
<a href=" https://angularjs.org/" id="tooltip560607963" target="_blank">
<img alt="..." className=" img-fluid opacity-3" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/angular.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip560607963">
</UncontrolledTooltip>
</Col>
<Col lg="2" xs="4">
<a href=" https://angularjs.org/" id="tooltip821379119" target="_blank">
<img alt="..." className=" img-fluid opacity-3" src={require("https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/react.jpg")}>
</img>
</a>
<UncontrolledTooltip delay={0} target="tooltip821379119">
[Coming Soon] React - A JavaScript library for building user interfaces
</UncontrolledTooltip>
</Col>
</Row>
</div>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="twitter" href="https://twitter.com/creativetim" id="tooltip98392199" size="lg" target="_blank">
<i className=" fa fa-twitter">
</i>
</Button>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="facebook" href="https://www.facebook.com/creativetim" id="tooltip885635179" size="lg" target="_blank">
<i className=" fa fa-facebook-square">
</i>
</Button>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="dribbble" href="https://dribbble.com/creativetim" id="tooltip984151185" size="lg" target="_blank">
<i className=" fa fa-dribbble">
</i>
</Button>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="github" href="https://github.com/creativetimofficial" id="tooltip588495598" size="lg" target="_blank">
<i className=" fa fa-github">
</i>
</Button>
