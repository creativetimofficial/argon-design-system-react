...
<NavItem>
<NavLink className=" nav-link-icon" href="https://www.facebook.com/creativetim" id="tooltip990883019" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip990883019">
Like us on Facebook
</UncontrolledTooltip>
</NavItem>
<NavItem>
<NavLink className=" nav-link-icon" href="https://www.instagram.com/creativetimofficial" id="tooltip928975275" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip928975275">
Follow us on Instagram
</UncontrolledTooltip>
</NavItem>
<NavItem>
<NavLink className=" nav-link-icon" href="https://twitter.com/creativetim" id="tooltip933833625" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip933833625">
Follow us on Twitter
</UncontrolledTooltip>
</NavItem>
<NavItem>
<NavLink className=" nav-link-icon" href="https://github.com/creativetimofficial/argon-design-system" id="tooltip486339579" target="_blank">
...
<UncontrolledTooltip delay={0} target="tooltip486339579">
Star us on Github
</UncontrolledTooltip>
</NavItem>
...
<Row className=" mt-3">
<Col xs="6">
<a className=" text-light" href="#pablo" onClick={e =>
 e.preventDefault()}>
<small>
Forgot password?
</small>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="twitter" href="https://twitter.com/creativetim" id="tooltip837435473" size="lg" target="_blank">
...
<Button className=" btn-neutral btn-icon-only btn-round" color="facebook" href="https://www.facebook.com/creativetim" id="tooltip337234511" size="lg" target="_blank">
<i className=" fa fa-facebook-square">
</i>
</Button>
...
<Button className=" btn-neutral btn-icon-only btn-round" color="dribbble" href="https://dribbble.com/creativetim" id="tooltip2802984" size="lg" target="_blank">
...
<Button className=" btn-neutral btn-icon-only btn-round" color="github" href="https://github.com/creativetimofficial" id="tooltip929250361" size="lg" target="_blank">
<i className=" fa fa-github">
</i>
</Button>
